...
namespace Microsoft.EntityFrameworkCore.SqlServer.Tests
{
    public class SqlServerSequenceValueGeneratorTest
    {
        ...
        private class FakeRawSqlCommandBuilder : IRawSqlCommandBuilder
        {
            ...
            public Tuple<IRelationalCommand, IReadOnlyDictionary<string, object>> Build(string sql, IReadOnlyList<object> parameters)
                => new Tuple<IRelationalCommand, IReadOnlyDictionary<string, object>>(
