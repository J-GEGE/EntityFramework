...
namespace Microsoft.EntityFrameworkCore.Storage
{
    public static class RelationalCommandBuilderExtensions
    {
            ...
            [NotNull] string name)
        {
            ...
            commandBuilder.ParameterList.AddParameter(invariantName, name);
            ...
            [NotNull] Type type)
        {
            ...
            commandBuilder.ParameterList.AddParameter(invariantName, name, type);
            ...
            [NotNull] IProperty property)
        {
            ...
            commandBuilder.ParameterList.AddParameter(invariantName, name, property);
            ...
            [NotNull] Action<IRelationalParameterList> listAction)
        {
            ...
            commandBuilder.ParameterList.AddCompositeParameter(invariantName, listAction);
